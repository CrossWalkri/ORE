...
version: 0.1.0
date: 2026-07-18
status: Companion mapping document. Shows where ORE attaches to each of the six CRAFT conditions, against CRAFT specification v0.4.4 and ORE specification v0.1.0. Descriptive of both documents; normative content lives in the specifications themselves.
license-intent: CC0
---
